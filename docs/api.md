# Extending Micboard
Micboard provides all data sent from receivers in a machine readable JSON format. This data is easily accessible via HTTP and WebSockets.  In addition to the data that micboard processes, micboard also supplies raw receiver data.
